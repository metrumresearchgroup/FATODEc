#ifndef FATODE_INTEGRATE_ODE_FWD_ROS_HPP
#define FATODE_INTEGRATE_ODE_FWD_ROS_HPP
...
namespace fatode_cc {
  ...
  void integrate_ode_fwd_ros( double tin, double tout,
                              int n,
                              int nnzero,
    ...
    integrate_fatode_fwd_ros_cc( &tin, &tout, &n, &nnzero,
                                 var.data(),
                                 rtol.data(), atol.data(),
                                 fatode_fun<FatOde<F> >(),
