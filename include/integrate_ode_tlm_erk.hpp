#ifndef FATODE_INTEGRATE_ODE_TLM_ERK_HPP
#define FATODE_INTEGRATE_ODE_TLM_ERK_HPP
...
namespace fatode_cc {
  ...
  void integrate_ode_tlm_erk( double tin, double tout,
                              int n,
                              int ntlm,
    ...
    integrate_fatode_tlm_erk_cc( &tin, &tout, &n, &ntlm,
